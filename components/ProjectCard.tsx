...
const ProjectCard = ({ card }: ProjectCardPorps) => {
  return (
    <div className="relative flex h-40 max-w-[49.6%] flex-1 flex-col items-center justify-around rounded border-[1px] border-[#333333] bg-gradient-to-br from-[#202020] to-[#151515] px-5 pb-5 pt-10 duration-300 ease-in-out hover:border-purple-400 hover:border-opacity-60 hover:from-[#242424] hover:to-[#101010]">
