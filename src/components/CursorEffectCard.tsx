...
export const CursorEffectCard = ({
  ...
  return (
    ...
    >
      ...
      {children && (
        <div className="gird relative h-40 place-content-center overflow-hidden rounded-[15px] border-neutral-950 bg-black/50 brightness-70 group-hover:brightness-100 duration-200">
          {children}
        </div>
      )}
