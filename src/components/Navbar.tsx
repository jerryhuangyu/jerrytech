...
const Navbar = ({ buttons }: NavbarProps) => {
  ...
  return (
    <div className="fixed top-8 z-50 grid grid-cols-2 gap-[0.5px] rounded-2xl bg-zinc-800/70 bg-clip-padding px-3 py-[6px] backdrop-blur sm:h-12 sm:grid-cols-5 sm:gap-1">
      {buttons.map(btn => (
